...
public class ServiceEntryModel {
    ...
    public ServiceEntryModel(String key, String cName, String date, String phone, String raw, String aro, String rejection, String parts, String price, String handcash, String workdone, String sign, String desc)
    {
        this.key=key;
        this.cName=cName;
        this.date=date;
